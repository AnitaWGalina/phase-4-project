...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["= 1.50.1"])
    s.add_development_dependency(%q<rubocop-minitest>.freeze, ["= 0.30.0"])
    ...
    s.add_dependency(%q<rubocop>.freeze, ["= 1.50.1"])
    s.add_dependency(%q<rubocop-minitest>.freeze, ["= 0.30.0"])
    ...
    s.add_dependency(%q<timecop>.freeze, ["= 0.9.6"])
    s.add_dependency(%q<yard>.freeze, ["= 0.9.34"])
  end
end
